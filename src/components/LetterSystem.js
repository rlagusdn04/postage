...
const CHARACTER_MESSAGES = {
  ...
  chet: [
    ...
    (nickname) => `from 🎭\n\n책을 읽던 중 인상 깊은 글을 읽었어요. "어제보다 오늘 사랑하려 애쓰고, 오늘보다 내일 더 사랑하려고 마음먹으시오." 당신에게도 그 진심이 아깝지않을만한 사람이 찾아오면 좋겠네요.\n\nTo. ${nickname}`,
     (nickname) => `from 🎭\n\n제 후회들은 보내지 말았어야할 편지같아요. 그저 내 머릿속 생각을 벗어날 방법이 필요한데 쉽지않네요. 그 이에게 말하지 않았던건 제게도 아직 말하지않았어요.\n\n결국 미리 준비한 말도, 마지막 인사도, 전하지못했네요. 당신이였으면 어떻게 했을 것 같나요?\n\n사실 난 오래도록 망설이는 사람이었어요.\n기회는 매번 흘러가고,\n말들은 머릿속에서만 맴돌다 잊혀졌죠.\n\n우유부단함은 결국, 비겁함의 다른 얼굴이더라고요.\n상처받기 싫어서, 책임지기 싫어서\n애써 모른 척하며 살아왔는지도 몰라요.\n그렇게 놓친 것들이 제법 많아요.\n\n그 중 어떤 것들은 지금도 아프게 남아 있어요.\n그리움은 끝내 닿지 못한 말들 속에 고여 있고,\n나는 여전히 그 자리에 서서\n그때 하지 못한 말들을 곱씹곤 해요.\n\n제 안좋은 습관이죠.\n당신도 고칠 수 없는 성정이 있나요? 혹은 고쳐본 경험이 있다면 듣고싶어요.\n\nTo. ${nickname}`,
    (nickname) => `from 🎭\n\n다음 편지는 단 한 번, 단 한 사람에게만 쓰는 편지예요.\n이번만큼은 여지를 남기지 않고싶네요. 실패하더라도 후회가 없도록 모든 것을 주고싶어요.\n예전엔 이런 저런 시도를 해봤죠, 하지만 그건 제 성격에 안맞는 것 같아요. 다음 번이 제 처음이자 마지막 진심이 되었으면해요.\n\n혹시 어떤 내용의 편지가 좋을까요?\n언제나 나의 마지막 용기가 되어줘서 고마워요.\n\nTo. ${nickname}`
  ...
  sangsoon: [
    ...
    (nickname) => `반갑고추.\n당신의 지난 편지, 몇 날을 곱씹었소.\n그 말마다 깃든 사유가 길고 깊어, 덜컥 답장을 올리기에는 내 마음이 여물지 않았기 때문이오.\n특히 그 마지막 물음, “기꺼이 손을 내밀 수 있었을까?”란 문장 앞에서 나는 한참을 멈추었소.\n\n사람 하나를 돕는 일이, 또 다른 이의 마음을 헤치는 일이 될 수 있다면, 그 의로움은 누구를 위한 것이며, 누구의 기준에서 비롯된 것일까요?\n\n내가 예전에 몸담았던 작은 산채에서, 사부는 한 무리의 떼를 물리치고 백성 하나를 구했소.\n헌데 그 무리의 아이 하나가, 훗날 산채를 습격했지요. “왜 그 한 명을 위해 다른 이를 죽였어야했나”고. 그 백성은 어쩌면 그들에겐 죽어 마땅한 자였을지도 모르오. 세상 그 누가 원한을 사지않고 살 수 있는 법이겠소. 범은 토끼를 괴롭히고 토끼는 망초를 괴롭혀야 살아갈 길이 있지요.\n그날 이후로 사부는 종종 혼잣말처럼 말하곤 했소.\n"도움이란 건, 물 한 종지 퍼주는 일 같지만… 그 물이 누구 목을 적시는진 알 수 없는 일이더라."\n\n그렇다고, 손을 거두는 게 과연 옳은가?\n그건 또 다른 책임의 회피일 테지요.\n그러니 나는 아직도 망설입니다.\n'정의롭다'는 말이 자칫 나를 면피케 하고,\n'협의롭다'는 마음이 실은 내 안의 자위는 아니었는지를요.\n\n혹자는 말하겠지요.\n진정한 협(俠)이란, 결과보다 그 마음과 의지에 있다고.\n하지만 나는 이제, 그 결과도 함께 짊어지려 합니다.\n누군가를 돕는다는 것은 누군가에게 원한은 사는 법, 그 생김의 무게까지 끌어안을 수 있어야 진짜 협이라 부를 수 있을 테니까요.\n\n그대는 어떻게 생각하오?\n의로움이 어느 누군가에겐 칼이 된다는 이 세상에서, 우리는 어떻게 옳음을 붙들 수 있을까요?\n\n당신의 생각이, 내 마음의 마지막 빗장을 열어줄지도 모르겠소.\n다시금 그대의 고견을 기다리며, 이만 붓을 놓습니다.\n\n당문 외문제자 상순 拜上`,
    (nickname) => `그대의 뜻에 참으로 감복했소. 천하에 태어나 뜻을 나눴으니 어찌 서로를 낯설게만 여기겠는가. 이제는 그저 친구처럼, 벗처럼 편히 말하오.\n\n그대는 풍류를 즐기시오?\n술잔에 달을 담아 그 인의를 나눌 시간이 기다려지오.\n그 날까지 호형호제하며 편안히 마음 터놓고 지내시구려.\n\nTo. ${nickname}`,
    (nickname) => `친우여 오늘은 비가 내립디다.\n\n보슬비 흩날리니 막을 길 없고, 방울방울 마음 위에 떨어지네. 이별 한지 스무 해, 굽어봐도 우러러봐도 어쩔 수 없구나. 출발한 길은 같으나 가는 길은 달랐으니 이제와 상심한 일은 다 말할 수 없네. 눈물을 곱게 닦아 시를 써서, 거문고 소리로 그대에게 전하리라.\n\n헤어짐과 만남은 부평초 같아 정해진게 없소이다,\n부디 그대도 소중한 인연을 잘 붙들길 바라겠소.\n\nTo. ${nickname}`,
    (nickname) => `무강하신가, 친우여.\n\n마교가 사라지니 사교가 나오고, 그 뒤엔 금과 서하가 들이쳤지. 난 도무지 그들이 악이라 단정지을 수가 없소. 세상은 왜 이리도 끝없이 다툼뿐일까. 사람은 꼭 누군가를 미워하고, 죽이지 않으면 안 되는 걸까. 서로 다른 곳에서 태어나, 각자의 신념과 이름을 위해 싸우다 끝내 사라지는 걸 보면, 강호마저 어느새 핏물 속에 녹는 것 같아.\n\n나도 한때는 '정'을 입에 달고 다녔건만, 그 입술이 몇 번을 피로 젖었던가. 파가 나뉘고 국이 나뉘어 그 편견으로 서로를 미워하니 의와 협이 마치 먼지처럼 흩어지고 마는구나. 우리 시대의 평화를 이룩하는 것은 모두가 죽지않는한 끝나지 않을 것같네만 그대는 어떠한가?\n\n골 백년이 지나면 모두가 풍요로워 천하에 근심과 욕망이 없어져 만세가 평화로울까, 그 몫은 부디 그대가 이어주기를 바라네.\n\nTo. ${nickname}`
  ],
  hyunwoo: [
    (nickname) => `?`
  ],
  ...
  cloud: [
    ...
    (nickname) => `from ☁️\n\n가끔 한가하면 달리는걸 좋아해.\n정해진 목표가 있는 것도 좋지만, 나는 그보다 '포기하지 않는 나'를 마주할 수 있다는 점에서 더 좋아.\n어찌됐든 한 발씩 나아가야 하잖아. 그 단순한 전진 속에서 오히려 내 복잡한 마음이 정리되는 기분이 들어.\n언제나 어제의 나보다 조금이라도 더 나아지고 싶은 마음,\n그걸 행동으로 증명할 수 있는 수단이야. 직관적 경험을 하다보면 아무렴 괜찮아보여.\n속도보다 중요한 건 멈추지 않는 거니까.\n\nTo. ${nickname}`,
    (nickname) => `from ☁️\n\n머릿속에서 수없이 시뮬레이션을 돌리다가, 마치 그 자체로 무언가를 이룬 것 같은 착각에 빠진 적이 많아.\n하지만 결국 세상은 생각이 아니라 행동을 기억하더라.\n나는 언제나 그 사람의 ‘의도’를 먼저 보려고 했어. \n그 사람이 왜 그런 선택을 했는지를 알고 싶었거든.\n그 때문에 남들도 나같은 거란 착각을 해왔었지.\n하지만 대개 사람들은 결과만 보지.\n그건 어쩌면 내가 너무 조용히, 너무 속으로만 생각해왔기 때문이겠지.\n비슷한 맥락으로 대화 사이 어색한 공백을 채우려 많은 미사여구 또는 마음에 없는 말을 하기보단 침묵이 나을 때가 많다는 것을 요즘 체감해.\n어설픈 말보다 차라리 무언이 더 진심일 때가 있으니까.\n적게 말하고, 많이 행동하자.\n\nTo. ${nickname}`,
    (nickname) => `from ☁️\n\n관계에 관해서 노력을 하지 않았으면서 왜 멀어졌냐고 서운해할 자격은 없어.\n가끔 가만히 있어도 유지된다는 오해를 하기 쉬운데, 장기적인 관계라면 그건 상대가 노력 중일 확률이 높아.\n만약 난 가만히 있었는데 왜? 라는 생각이 든다면, 그 역시 내가 아무것도 하지 않았기 때문이야.\n가만히 있는 것도 일종의 선택이고, 그 선택은 결과를 낳지.\n나는 그런 관계들을 몇 번이나 흘려보내봤어.\n이젠 억울한 마음보다 먼저, 내가 했던 행동하지 않았던 행동을 돌아보게 되더라고.\n반대로 관계는 유지하려는 쪽의 노력이 닳아버렸을 때, 그 사람은 미련 없이 떠날 수 있어.\n내가 할 수 있는 만큼은 해보자고 다짐해.\n덕분에, 후회와 미련 없이 떠나보낼 수 있는 인연도 생겼어.\n\nTo. ${nickname}`,
    (nickname) => `from ☁️\n\n현대 사회에서 한 사람의 행동이 사회적인 책임을 다하지 못하거나, 서로 간의 이해가 충분하지 않을 때 우리는 종종 타인을 민폐로 여기게 되는 순간들을 마주하게 돼.\n처음엔 그게 그저 조심하려는 마음에서 비롯된, 수동적인 배려일 수 있어. 누군가를 불편하게 만들지 않기 위한 아주 작은 의도 말이야.\n그런데 점점 그런 태도가 서로를 단절시키는 장벽이 되어버리는 걸 보게 돼.\n진짜 필요한 건, 침묵 속에 숨어 있는 배려가 아니라, 관계 안에서의 ‘적극적인 이해’와 ‘움직이는 마음’이라는 걸 이제는 알아.\n\n나도 그래.\n무심코 지나친 순간들 속에서 누군가를 불편하게 했을지도 모르지.\n처음엔 두려웠어. 내가 의식하지 못한 무언가가 누군가에게 상처를 줄 수 있다는 사실이.\n하지만 돌이켜보면 사람은 누구나 자각 없이 살아가는 부분이 있어.\n완벽한 사람은 없다는 걸 받아들이는 순간, 그 부족함 속에서도 서로를 배려하려는 마음이 생겨나는 것 같아.\n\n내가 누군가에게 민폐가 되었을 수 있다는 자각,\n그건 나를 작게 만드는 게 아니라,\n도리어 사람 사이의 온기를 회복시키는 첫걸음이 되는 것 같아.\n관계 속에서 내 행동이 어떤 영향을 남기는지를 헤아릴 줄 아는 사람,\n나도 그런 사람이 되고 싶어.\n그래서 아주 작은 일에도 다시금 내 마음을 살피게 돼.\n그렇다고 너무 걱정하지는 마. 너뿐만 아니라 다들, 사람들은 모두가 자각 없이 살아가니까.\n\nTo. ${nickname}`,
...
/*
웹페이지에서 캐릭터 목록을 보여줄 때
Object.entries(characterInfo) 또는 Object.keys(characterInfo)로 순회하면
정의된 순서대로(위 순서대로) 출력됩니다.

만약 캐릭터 선택 UI에서 순서가 뒤섞여 나온다면,
아래처럼 명시적으로 순서를 지정해 렌더링하세요:

const characterOrder = [
  "cloud", "chet", "coffee", "honga", "sangsoon", "hyunwoo", "danpoong"
];

characterOrder.map(id => {
  const info = characterInfo[id];
  // info.name, info.avatar, info.quote 사용
});
